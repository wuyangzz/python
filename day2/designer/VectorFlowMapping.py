...
"border-radius: 20px;")
        ...
        self.ImageShow.setGeometry(QtCore.QRect(0, 0, 871, 740))
...
"border-radius: 20px;")
        ...
        self.PromptInformation = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.PromptInformation.sizePolicy().hasHeightForWidth())
        self.PromptInformation.setSizePolicy(sizePolicy)
        self.PromptInformation.setMinimumSize(QtCore.QSize(0, 37))
        self.PromptInformation.setMaximumSize(QtCore.QSize(16777215, 37))
        self.PromptInformation.setStyleSheet("background-color: rgb(170, 0, 255);\n"
"border-radius: 20px !important ;")
        self.PromptInformation.setObjectName("PromptInformation")
        self.gridLayout.addWidget(self.PromptInformation, 19, 0, 1, 2)
